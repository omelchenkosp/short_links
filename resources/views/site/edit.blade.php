        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['url' => route('site.update'), 'role'=>'form', 'method'=>'POST', 'enctype'=>'multipart/form-data']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <?php
                                $life = 'f';
                                if ($link['date_end']) {
                                    $seconds = $link['date_end'] - $link['date_start'];
                                    //24 * 60 * 60 = 86400 sec in day
                                    //7 * 86400 = 604800 sec in week
                                }
                            ?>
